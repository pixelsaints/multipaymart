...
switch ($current_style) {
	...
	case 'home-header': ?>
		<div class="header-main flex items-center justify-between p-4 bg-white shadow-md">
			<div class="logo">
	...
	case 'page-header': ?>
		<div class="page-header flex items-center justify-between p-4 bg-gray-100">
			<?php if ($show_back): ?>
			...
			<?php if ($show_notifications): ?>
				<a href="#" class="notifications relative">
					...
					<span class="number absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full px-1">1</span>
				</a>
			<?php endif; ?>
		</div>
	<?php break;
	...
	case 'default':
	default: ?>
	<div class="header-main flex items-center justify-between p-4 bg-gray-100 shadow-md">
		<a href="javascript:history.back()" class="back-btn">
			<i class="fa-solid fa-arrow-left"></i>
		</a>
